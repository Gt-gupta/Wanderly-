...
const { createPost , createPool , createFriend ,postLike, postOpinion,postMessage} = require('../controllers/postController'); // Import the controller
...
router.post('/createPool',authMiddleware,createPool);
